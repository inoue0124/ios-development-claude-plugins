...
個別スキル（mvvm-check, layer-dependency-check, di-pattern-suggest, protocol-oriented-check, concurrency-check）と
...
5. **concurrency-check** — Swift Concurrency の安全性検査
...
| Concurrency | Sendable 違反・actor 分離不備 0 件 | 1 件以上 |
